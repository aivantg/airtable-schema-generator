...
This has been updated to `console.log` a warning instead - you will **still need to run the generator** upon schema changes to be able to actually process data for new/modified columns and tables but the generator will no longer throw errors causing apps to stop working.
